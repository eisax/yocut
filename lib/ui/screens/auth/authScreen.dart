...
import 'package:yocut/ui/widgets/customRoundedButtorn.dart';
...
class _AuthScreenState extends State<AuthScreen> with TickerProviderStateMixin {
  ...
  late final Animation<double> _bottomMenuHeightDownAnimation = Tween<double>(
    begin: 0.0,
    end: 1.0,
  ).animate(
    CurvedAnimation(
                      ...
                      return Column(
                        ...
                        children: [
                          Padding(
                              ...
                              child: Text(
                                "Transorm Your CUT Portal And Coursework With YoCUT",
                                // context
